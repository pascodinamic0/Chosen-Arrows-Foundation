---
allowed-tools: [Read, Write, Edit, Glob, Grep, TodoWrite, Task, mcp__sequential-thinking__sequentialthinking, mcp__context7__context7, mcp__magic__magic]
...
## Usage
```
/workflow [prd-file|feature-description] [--persona expert] [--c7] [--sequential] [--strategy systematic|agile|mvp] [--output roadmap|tasks|detailed] [--estimate] [--dependencies] [--risks] [--parallel] [--milestones]
```
...
- **Cross-Command Integration** - Seamless handoff to implement, analyze, design, and other agent commands
